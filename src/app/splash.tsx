...
export default function SplashScreen() {
  ...
  return <AppScreen><View style={styles.center}><Animated.View entering={FadeIn.duration(420)}><LogoMark /></Animated.View><Animated.Text entering={FadeInDown.delay(120).duration(420)} style={styles.line}>Smarter market context, in one clear brief.</Animated.Text><Animated.View accessibilityLabel="Preparing MarketBrief" accessibilityRole="progressbar" style={[styles.loader, animated]} /></View><Text style={styles.note}>Illustrative preview · preferences stay on this device</Text></AppScreen>;
}
