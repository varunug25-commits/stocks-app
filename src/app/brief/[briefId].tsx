...
const styles = StyleSheet.create({
  scroll: { width: "100%", maxWidth: 680, alignSelf: "center", padding: spacing.lg, paddingBottom: spacing.xxxl },
  ...
  summaryCard: { gap: spacing.md, padding: spacing.lg, borderRadius: radii.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  changeCard: { padding: spacing.lg, borderRadius: radii.lg, backgroundColor: colors.surfaceElevated, borderWidth: 1, borderColor: colors.border },
  ...
  eventCard: { paddingHorizontal: spacing.md, borderRadius: radii.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, overflow: "hidden" },
  monitorCard: { padding: spacing.lg, borderRadius: radii.lg, backgroundColor: colors.surface },
  ...
  scenario: { padding: spacing.lg, borderRadius: radii.lg, borderWidth: 1 },
  positive: { backgroundColor: "#13251D", borderColor: "#28553C" },
  risk: { backgroundColor: "#292317", borderColor: "#5A4923" },
  ...
  sources: { paddingHorizontal: spacing.md, borderRadius: radii.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
